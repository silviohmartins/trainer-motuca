...
- **A janela nunca foi aberta em uma partida.** Layout, posições, recorte de texto, comportamento das abas, foco dos campos e a keybind F6 não foram testados no jogo. Este é o item bloqueante antes de publicar.
